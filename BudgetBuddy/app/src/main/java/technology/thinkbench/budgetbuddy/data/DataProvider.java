...
public class DataProvider extends ContentProvider {
    ...
    private int updatePet(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        //if (values.containsKey(ExpenditureEntry.COLUMN_PET_GENDER)) {
        //    Integer gender = values.getAsInteger(ExpenditureEntry.COLUMN_PET_GENDER);
        ...
        //if (values.containsKey(ExpenditureEntry.COLUMN_PET_WEIGHT)) {
        // Check that the weight is greater than or equal to 0 kg
        //    Integer weight = values.getAsInteger(ExpenditureEntry.COLUMN_PET_WEIGHT);
